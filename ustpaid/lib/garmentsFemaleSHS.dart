...
class GarmentsFemaleSHS extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: SingleChildScrollView(
        ...
        labelCategory(),
        productFemaleSHSUpper(),
        productFemaleSHSLower(),
        productPEUpper(),
        productPELower()
      ])),
    ));
      ...
      child: Column(
        ...
        children: <Widget>[
          const ListTile(
            ...
            subtitle: Text('Female (Senior High School',
...
Widget productFemaleSHSUpper() => Container(
          ...
          children: [
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text("Female SHS Upper Uniform",
                          style:
...
Widget productFemaleSHSLower() => Container(
    padding: EdgeInsets.all(1),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
          ...
          children: [
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text("Male SHS Lower Uniform",
                          style:
                              TextStyle(fontSize: 20.0, color: Colors.white)),
                    ),
                    Center(
