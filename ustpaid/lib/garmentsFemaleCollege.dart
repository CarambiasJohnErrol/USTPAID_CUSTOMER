...
class GarmentsFemaleCollege extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: SingleChildScrollView(
        ...
        labelCategory(),
        productFemaleCollegeUpper(),
        productFemaleCollegeLower(),
        productPEUpper(),
        productPELower()
      ])),
    ));
...
Widget productFemaleCollegeUpper() => Container(
          ...
          children: [
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text("Female College Upper Uniform",
                          style:
...
Widget productFemaleCollegeLower() => Container(
    padding: EdgeInsets.all(1),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
          ...
          children: [
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text("Female College Lower Uniform",
                          style:
                              TextStyle(fontSize: 20.0, color: Colors.white)),
                    ),
                    Center(
