...
class GarmentsMaleSHS extends StatelessWidget {
  @override
      ...
      child: Column(
        ...
        children: <Widget>[
          const ListTile(
            ...
            subtitle: Text('Male (Senior High School)',
...
Widget productMaleSHSUpper() => Container(
          ...
          children: [
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text("Male SHS Upper Uniform",
                          style:
...
Widget productMaleSHSLower() => Container(
    padding: EdgeInsets.all(1),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
